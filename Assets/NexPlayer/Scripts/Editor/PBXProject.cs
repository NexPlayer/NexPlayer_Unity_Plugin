...
namespace NexPlayer.UnityEditor.iOS.Xcode
{
    ...
    public class PBXProject
    {
        ...
        */
		...
		public bool AddDynamicFrameworkToProject(string targetGuid, string frameworkPathInProject)
		{
			...
			PBXBuildFileData embedFrameworkFileData = PBXBuildFileData.CreateFromFileWithExtraSettings(fileGuid, false, null);
			embedFrameworkFileData.UpdateProps ();
