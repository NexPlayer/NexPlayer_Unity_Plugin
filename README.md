...
<a align=right><img src="resources/NexPlayer_logo_white_bckg.png" width="100%" height="100%"></a>
</p></h1>
 ...
 <tbody style="text-align:center;">
   <tr>
     ...
     <td>
       ...
       <li>Multi-Instance Streaming (Display Multiple Streams Simultaneously)</li>
